...
echo  [1/5] Downloading Three.js r134 (3D engine)...
...
echo  [2/5] Downloading OrbitControls (camera)...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
...
echo  [3/5] Downloading OBJLoader (terrain import)...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
...
echo  [4/5] Downloading STLLoader (STL terrain import)...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
...
echo  [5/5] Downloading TensorFlow.js 4.10 (DQN RL engine)...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
